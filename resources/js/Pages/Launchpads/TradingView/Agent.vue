...
import { CoTelegram, BiArrowRightShort } from "oh-vue-icons/icons";
...
<template>
	<div
		class="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-800 transition-all duration-300"
	>
		<!-- Bot Info -->
		<div class="p-5 relative">
			<div
				class="absolute top-3 right-3 bg-primary text-gray-900 font-semibold text-xs px-2 py-1 rounded-full"
			>
				{{ "Utility" }}
			</div>
			...
			<div class="flex justify-between text-gray-400 text-sm mb-5">
				...
				<div
					class="flex gap-2 text-gray-250 bg-gray-750 items-center px-2 py-1 rounded-full"
				>
					<span
						>{{ bot.credits_per_message.toFixed(1) }}
			...
			<div class="flex justify-end gap-3">
				...
				>
					<VueIcon :icon="CoTelegram" class="w-5 h-5 mr-1 -ml-1 inline-flex" />
