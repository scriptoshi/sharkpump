...
const supportedChains = computed(() => Object.keys(props.foundry.addresses));

const foundryAddress = computed(() => props.foundry.addresses[chainId.value]);
			...
			<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
				...
				>
					...
					<div class="sm:col-span-2 lg:col-span-4">
						...
						<p class="mb-3">
							Donot Edit edit the UniswapV3 addresses unless you know what
							you are doing. Wrong addresses could lead to contributions
							getting stuck for good on the launchpad pool.
						</p>
