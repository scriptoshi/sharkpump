        ...
        <div class="card-body card-gutterless h-full">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="sm:col-span-2 lg:col-span-4 mb-6">
                    ...
                    <div
                        v-else
                        class="grid sm:grid-cols-4 gap-4 border-gray-650"
                    >
                        <div>
                ...
                <div class="sm:col-span-2 border border-gray-750 p-4 rounded-lg">
                    ...
                    <div class="flex mt-4 justify-center sm:justify-end sm:flex-row sm:items-center gap-3">
                        <TxStatus
                            :state="state"
                            v-show="state.called == 'setBaseURI'"
                        />
                        <PrimaryButton
                            @click="setBaseUri"
                ...
                <!-- Contract Status -->
                <div class="sm:col-span-2 lg:col-span-4 border border-gray-750 p-4 rounded-lg">
                ...
                <div class="sm:col-span-2 lg:col-span-4 border border-gray-750 p-4 rounded-lg">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <PrimaryButton
                                @click="withdrawFees"
                                :disabled="state.busy == 'withdrawFees' ||
                                    !contractBalance ||
                                    contractBalance === '0'
                                    "
                            >
                ...
                <div class="sm:col-span-2 lg:col-span-4 border border-gray-750 p-4 rounded-lg">
                    <div class="flex items-center gap-6 justify-between">
                        <div class="flex-1 p-6 bg-gray-750 rounded-lg">
                            ...
                            <div class="mb-8">
                                <FormLabel class="mb-1">{{ $t('Description') }}</FormLabel>
                                <FormTextArea
                                    v-model="form.description"
                                    :error="form.errors.description"
                                    placeholder="Enter a description for your NFT Badge"
                                />
                            </div>
                            <div class="gap-x-3 grid gap-3">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <img
                                        ...
                                        :src="form.logo_uri ?? props.nft.image ?? fakeLogo
                                            "
                                    />
                                    <PrimaryButton
                                        @click="save"
