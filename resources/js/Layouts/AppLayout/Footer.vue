				...
				<div class="grid grid-cols-2 md:grid-cols-6 gap-8">
					...
					<div>
						<ul class="space-y-4">
							...
							<li class="hidden" v-if="$page.props.links.documentation">
								<a
					...
					<div>
						<ul class="space-y-4">
							...
							<li class="hidden" v-if="$page.props.links.discord">
								<a
							...
							<li class="hidden" v-if="$page.props.links.youtube">
								<a
					...
					<div class="space-y-4">
						<h3 class="text-white font-medium hidden">
