...
const classes = computed(() => {
    if (xs.value)
        return `py-1 text-xs ${lead.value ? "pl-12" : "pl-1"} ${trail.value ? "pr-12" : "pr-1"
            }`;
    if (xm.value)
...
<template>
    <div>
        ...
        <div
            ...
            class="relative rounded shadow-sm"
        >
            <div
                v-if="$slots.lead"
            ...
            <input
                ...
                :class="[
                    ...
                    error
                        ...
                        : 'bg-white border-gray-300 text-gray-900  rounded focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white',
                    classes,
